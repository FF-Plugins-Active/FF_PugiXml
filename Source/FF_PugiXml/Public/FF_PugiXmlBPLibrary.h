...
class UFF_PugiXmlBPLibrary : public UBlueprintFunctionLibrary
{
	...
	*/
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Pugixml - Get Attribute Value", Tooltip = "", Keywords = "pugixml, xml, document, get, node, read, attribute, value"), Category = "FF_PugiXml|Parse")
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Pugixml - Set Name", Tooltip = "", Keywords = "pugixml, xml, document, set, node, read, name"), Category = "FF_PugiXml|Edit")
	static FF_PUGIXML_API bool PugiXml_Set_Name(UFFPugiXml_Node* Target_Node, FString In_Name);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Pugixml - Set Value", Tooltip = "", Keywords = "pugixml, xml, document, set, node, read, value"), Category = "FF_PugiXml|Edit")
	static FF_PUGIXML_API bool PugiXml_Set_Value(UFFPugiXml_Node* Target_Node, FString In_Value);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Pugixml - Set Attributes", Tooltip = "", Keywords = "pugixml, xml, document, set, add, node, read, attribute, attributes"), Category = "FF_PugiXml|Edit")
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Pugixml - Remove Node 1", Tooltip = "It has to be direct child/parent not grand-children.", Keywords = "pugixml, xml, document, node, remove"), Category = "FF_PugiXml|Edit")
	static FF_PUGIXML_API bool PugiXml_Node_Remove_1(UPARAM(ref)UObject*& Source, UPARAM(ref)UFFPugiXml_Node*& Delete_Target);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Pugixml - Remove Node 2", Tooltip = "It automatically finds parent.", Keywords = "pugixml, xml, document, node, remove"), Category = "FF_PugiXml|Edit")
